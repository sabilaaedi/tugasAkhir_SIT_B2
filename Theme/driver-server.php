<?php
    ...
    $server->register('fungsiDriver',
        array('id_driver' => 'xsd:string'),
        array('id_driver'=>'xsd:Array'),
    ...
    function fungsiDriver(){
        $res = dbConnect("SELECT id_driver, nama, alamat, jk, telepon FROM driver");
